...
namespace Vfixtechnology\Menu\Facades {
     ...
     */        class Menu {
         ...
         */        public static function render()
        {
                        /** @var \Vfixtechnology\Menu\WMenu $instance */
                        return $instance->render();
        }
                    /**
         * @static
        ...
        {
                        return \Vfixtechnology\Menu\WMenu::getByName($name);
        }
                    /**
         * @static
         */        public static function get($menu_id)
        {
                        return \Vfixtechnology\Menu\WMenu::get($menu_id);
        }
            }
    }
...
namespace  {
            ...
            class Menu extends \Vfixtechnology\Menu\Facades\Menu {}
