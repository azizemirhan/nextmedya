    ...
    <div class="container my-5">
        <div class="row gy-4">
            ...
            <div class="col-6 col-md-3 col-lg-2">
                <div class="card h-100 shadow-sm">
                    <div class="card-body d-flex justify-content-center align-items-center p-3">
                        <img src="{{ asset('uploads/companies/30.png') }}" class="img-fluid" alt="Referans 20">
                    </div>
                </div>
            </div>
             <div class="col-6 col-md-3 col-lg-2">
                <div class="card h-100 shadow-sm">
                    <div class="card-body d-flex justify-content-center align-items-center p-3">
                        <img src="{{ asset('uploads/companies/31.png') }}" class="img-fluid" alt="Referans 20">
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-top: 100px;">
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat2 cat4">
                <div class="tp-project-5-2-thumb anim-zoomin-wrap mb-30 p-relative not-hide-cursor"
                    ...
                    <a class="cursor-hide" href="#">
                        <span>
                            <img class="anim-zoomin" src="{{ asset('tuncay.png') }}" alt="" />
                        </span>
                    </a>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat2 cat4">
                <div class="tp-project-5-2-thumb anim-zoomin-wrap mb-30 p-relative not-hide-cursor"
                    ...
                    <a class="cursor-hide" href="#">
                        <span>
                            <img class="anim-zoomin" src="{{ asset('tuntas.png') }}" alt="" />
                        </span>
                    </a>
                </div>
            </div>
