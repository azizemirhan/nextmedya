...
<head>
    ...
    <link href="{{ asset('backend/layouts/horizontal-light-menu/css/dark/loader.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('backend/layouts/horizontal-light-menu/css/dark/plugins.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto top-0 start-0 text-center justify-content-center flex-column">
                ...
                <div class="auth-cover">
                    ...
                    <div class="position-relative">
                        ...
                        <img src="{{ asset('backend/src/assets/img/auth-cover.svg') }}" alt="auth-img">
