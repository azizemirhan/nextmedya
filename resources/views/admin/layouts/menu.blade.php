        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-text">
                    <a href="index.html" class="nav-link">Next Medya WEBPanel </a>
                </li>
            </ul>
                ...
                <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('backend/src/assets/img/1x1/us.svg') }}" class="flag-width"
                                alt="flag">
                            <span class="align-self-center">&nbsp;English</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('backend/src/assets/img/1x1/tr.svg') }}" class="flag-width"
                                alt="flag">
                            <span class="align-self-center">&nbsp;Turkish</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('backend/src/assets/img/1x1/br.svg') }}" class="flag-width"
                                alt="flag">
                            <span class="align-self-center">&nbsp;Portuguese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('backend/src/assets/img/1x1/in.svg') }}" class="flag-width"
                                alt="flag">
                            <span class="align-self-center">&nbsp;Hindi</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('backend/src/assets/img/1x1/de.svg') }}" class="flag-width"
                                alt="flag">
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="{{ asset('backend/src/assets/img/profile-30.png') }}"
