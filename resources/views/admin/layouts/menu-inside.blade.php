        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <ul class="navbar-nav ms-3 d-none d-lg-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M2.5 3a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h6a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1z"/>
                        </svg>
                ...
                <!-- Talepler -->
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.contactforms.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div class="offcanvas-body">
        <div class="list-group list-group-flush">
            ...
            <div class="mb-3">
                ...
                <a href="{{ route('admin.contactforms.index') }}" class="list-group-item list-group-item-action">
                    <i class="bi bi-info-circle me-2"></i>Talepler
                </a>
