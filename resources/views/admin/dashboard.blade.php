...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                <a href="{{ route('admin.contacts.index', ['unread'=>1]) }}" class="text-decoration-none">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-muted">Okunmamış Mesaj</div>
                            <div class="h3 mb-0">{{ $cards['contact_unread'] }}</div>
                        </div>
                    </div>
                </a>
            </div>
