...
Route::middleware('is_admin')->group(function () {
    ...
    Route::post('pages/sections/reorder', [\App\Http\Controllers\Admin\PageController::class, 'reorderSections'])
        ->name('pages.sections.reorder');

    Route::post('pages/sections/toggle-status/{section}', [\App\Http\Controllers\Admin\PageController::class, 'toggleStatus'])
        ->whereNumber('section')
